      ...
      >
        ...
        <View style={styles.contentView}>
          <View style={styles.viewSlogan}>
            ...
            <Text style={styles.sloganText} allowFontScaling={false}>
          ...
          <View style={styles.viewButtons}>
            ...
            >
              <Text style={styles.textMainButton} allowFontScaling={false}>
                Contribuir
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
        ...
        <View>
          <Image
            style={[
              styles.dogImage,
              { height: imageHeight, width: imageWidth, objectFit: "cover" },
            ]}
            source={DogImage}
          />
        </View>
